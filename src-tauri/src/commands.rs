...
/// Get network capabilities (NAT detection)
#[tauri::command]
pub async fn get_network_capabilities() -> Result<crate::network_probe::NetworkCapabilities, String> {
    Ok(crate::network_probe::probe_network().await)
}
